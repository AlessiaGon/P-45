...
function preload(){
  trex_correndo =   loadAnimation("balão.png");
  trex_colidiu = loadAnimation("balão.png");
  
  imagemDoSolo = loadImage("ground2.png");
  
  imagemDaNuvem = loadImage("cloud.png");
  
  obstaculo1 = loadImage("Avião.png");
  obstaculo2 = loadImage("Avião2.png");
  obstaculo3 = loadImage("Helicóptero.png");
  obstaculo4 = loadImage("Helicóptero2.png");
  obstaculo5 = loadImage("Passarinho.png");
  obstaculo6 = loadImage("Passarinho2.png");
